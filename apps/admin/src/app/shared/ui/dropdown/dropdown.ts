...
@Component({
  ...
  template: `
    ...
    >
      <sgb-icon [icon]="icon" size="sm" class="mr-2" />
      <p>{{ text }}</p>
    </button>
...
export class GbDropdownItemComponent {
  @Input() icon = '';
  @Input() text = '';
...
export class GbDropdownComponent {
  @ContentChildren(GbDropdownItemComponent)
  dropdownItems!: QueryList<GbDropdownItemComponent>;
